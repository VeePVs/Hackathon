...
def responder_pregunta(texto):
    ...
    if ("nomina" in texto or "nómina" in texto) and ("pague" in texto or "pagué" in texto):
        ...
        return (
            ...
            "- Cuanto pagué en nómina el marzo pasado\n"
            "- Cuantos empleados tengo activos actualmente\n"
            "- Cuál fue el salario promedio de los empleados en julio de 2023\n"
            "- Qué descuentos en abril del 2024 tuvo el empleado Samuel *fundamental que tenga el formato al final -empleado nombre-*\n"
            "- Cuantos dias trabajo en junio del 2024 el empleado Samuel *fundamental que tenga el formato al final -empleado nombre-*\n"
