...
def responder_pregunta(texto):
    ...
    if ("nomina" in texto or "nómina" in texto) and ("pague" in texto or "pagué" in texto):
        ...
        return (
            ...
            "- Qué descuentos en abril del 2024 tuvo el empleado Laura *fundamental que tenga el formato al final -empleado nombre-*\n"
            "- Cuántos días trabajó en junio del 2024 el empleado Carlos *fundamental que tenga el formato al final -empleado nombre-*\n"
